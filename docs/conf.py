...
templates_path = ['.']
extlinks = {
    'issue': ('https://github.com/draimondi/hearing-exam/issues/%s', '#'),  # noqa: E501
    'pr': ('https://github.com/draimondi/hearing-exam/pull/%s', 'PR #'),  # noqa: E501
    }
...
linkcheck_ignore = [
    r'https://codecov.io/gh/draimondi/hearing-exam/*',
    ]

html_theme = "sphinx_py3doc_enhanced_theme"
html_theme_path = [sphinx_py3doc_enhanced_theme.get_html_theme_path()]
html_theme_options = {
    'githuburl': 'https://github.com/draimondi/hearing-exam',
    }
